...
<?php
$result = mysqli_query($conn,"SELECT * FROM `products` LIMIT 0,8");
...
?>
<?php
$result = mysqli_query($conn,"SELECT * FROM `products` LIMIT 8,16");
while($row = mysqli_fetch_assoc($result)){
...
?>
<?php
$result = mysqli_query($conn,"SELECT * FROM `products` LIMIT 16,24");
while($row = mysqli_fetch_assoc($result)){
